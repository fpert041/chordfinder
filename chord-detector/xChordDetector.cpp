...
#include "xChordDetector.hpp"
#include <math.h>

//=======================================================================
xChordDetector::xChordDetector()
{
    bias = 1.06;
...
//=======================================================================
void xChordDetector::detectChord(std::vector<double> chroma)
{
    detectChord(&chroma[0]);
}

//=======================================================================
void xChordDetector::detectChord(double *chroma)
{
    for (int i = 0;i < 12;i++)
    {
...
//=======================================================================
void xChordDetector::classifyChromagram()
{
    int i;
    int j;
    int fifth;
...
//=======================================================================
double xChordDetector::calculateChordScore(double *chroma,double *chordProfile,double biasToUse, double N)
{
    double sum = 0;
    double delta;
...
//=======================================================================
int xChordDetector::minimumIndex(double *array,int arrayLength)
{
...
//=======================================================================
void xChordDetector::makeChordProfiles()
{
    int i;
    int t;
    int j = 0;
