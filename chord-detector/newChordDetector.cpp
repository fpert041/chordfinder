...
//=======================================================================
void newChordDetector::detectChord(std::vector<double> chroma)
{
    detectChord(&chroma[0]);
}

//=======================================================================
void newChordDetector::detectChord(double *chroma)
{
    for (int i = 0;i < 12;i++)
    {
...
//=======================================================================
double newChordDetector::calculateChordScore(double *chroma,double *chordProfile,double biasToUse, double N)
{
    double sum = 0;
    double delta;
...
//=======================================================================
int newChordDetector::minimumIndex(double *array,int arrayLength)
{
